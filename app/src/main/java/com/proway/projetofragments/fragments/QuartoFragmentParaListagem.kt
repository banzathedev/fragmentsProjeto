 ...
 * Use the [QuartoFragmentParaListagem.newInstance] factory method to
...
class QuartoFragmentParaListagem : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment QuartoFragmentParaListagem.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            QuartoFragmentParaListagem().apply {
